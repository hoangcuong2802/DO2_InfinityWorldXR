...
namespace ARLocation
{
    ...
    public class ARLocationConfigInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox("AR+GPS Location " + ARLocationConfig.Version, UnityEditor.MessageType.None, true);
		...
		EditorGUILayout.HelpBox("Make sure that Vuforia is instaled in the Package Manager Window.  On Android, also make sure that the 'ARCore XR Plugin' is not installed.", MessageType.Info);
                ...
                EditorGUILayout.HelpBox(
                    "Note that the regular sample scenes do not work with Vuforia. You can download a project with Vuforia samples at https://github.com/dmbfm/unity-ar-gps-location-issues/releases/tag/v3.1.1", UnityEditor.MessageType.Warning);
            }
